...
function MovieList({ search }) {
  ...
  const fetchMovies = async () => {
    const response = await fetch(
      "https://api.themoviedb.org/3/movie/popular?api_key=74a42177ce5a129faa96c4a04b749de8"
    );
  ...
  return (
    <section className="movie-list">
      <header className="align-center movie-list-header">
        <h2 className="align-center movie-list-heading">Popular Movies 🎬</h2>
        ...
        <div className="align-center movie-list-fs">
          ...
          >
            ...
            <option value="rate_average">Rating</option>
          </select>
